...
int main(void)
{
	...
	if ((_handle = pcap_open_live(tempDev->name, 65536, 1, 1000, errbuf)) == NULL) {
		printf("  ");
		pcap_freealldevs(allDev);
		return -1;
	}
	...
	arp.target_host[1] = 0x01;
	arp.target_host[2] = 0x36;
	arp.target_host[3] = 0xf4;
	arp.target_host[4] = 0x54;
	arp.target_host[5] = 0x97;
